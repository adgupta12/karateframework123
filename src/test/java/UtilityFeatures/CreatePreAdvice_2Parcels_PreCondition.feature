...
Feature: CreatePreAdvice_2Parcels_PreCondition 
...
* def parcelNumber1_PC = parcelNum1
* print 'parcelNumber -> ', parcelNumber1_PC
* def parcelNumber2_PC = parcelNum2
* print 'parcelNumber -> ', parcelNumber2_PC
...
Scenario: CreatePreAdvice_2Parcels_PreCondition
					...
					<pre:Consignments>
						<pre:Consignment>
							<pre:ParcelAttributes>
								<pre:ParcelNumber>#(parcelNumber1_PC)</pre:ParcelNumber>
						...
						<pre:Consignment>
							<pre:ParcelAttributes>
								<pre:ParcelNumber>#(parcelNumber2_PC)</pre:ParcelNumber>
								<pre:ParcelType>#(parcelType_PC)</pre:ParcelType>
								<pre:ExternalOrderNumber>#(externalOrderNumber_PC)</pre:ExternalOrderNumber>
								<pre:InjectionFacility>07520</pre:InjectionFacility>
								<pre:InjectionFacilityType>NSC</pre:InjectionFacilityType>
