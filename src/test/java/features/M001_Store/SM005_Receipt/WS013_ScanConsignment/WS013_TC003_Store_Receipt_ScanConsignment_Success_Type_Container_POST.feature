@All @WS013 @WS013_TC003 @Store @ScanConsignment @ignore
Feature: WS013_TC003_Store_Receipt_ScanConsignment_Success_Type_Container_POST

Background:
* print 'ws_url -> ', ws_url
* print 'currentDateTimeStamp -> ', currentDateTimeStamp

Scenario Outline: WS013_TC003_<scenarioId>_Store_Receipt_ScanConsignment_Success_Type_Container_POST
