@All @WS013 @WS013_TC001 @Store @ScanConsignment @ignore
Feature: WS013_TC001_Store_Receipt_ScanConsignment_Success_POST

Background:
* print 'ws_url -> ', ws_url
* print 'currentDateTimeStamp -> ', currentDateTimeStamp

Scenario Outline: WS013_TC001_<scenarioId>_Store_Receipt_ScanConsignment_Success_POST
...
#* def containerId = getParcelDetailsForNotReceivedContainers[5]
