@All @WS019 @WS019_TC002 @Store @ExtendDwellTime
Feature: WS019_TC002_Store_ExtendDwellTime_ParcelLevel_Success_POST

Background:
* print 'ws_url -> ', ws_url
* print 'currentDateTimeStamp -> ', currentDateTimeStamp

Scenario Outline: WS019_TC002_<scenarioId>_Store_ExtendDwellTime_ParcelLevel_Success_POST
