@All @WS031 @WS031_TC001 @Store @MoveParcel
Feature: WS031_TC001_Store_MoveParcel_Success_POST

Background:
* print 'ws_url -> ', ws_url
* print 'currentDateTimeStamp -> ', currentDateTimeStamp

Scenario Outline: WS031_TC001_<scenarioId>_Store_MoveParcel_Success_POST
...
And match $.response.payload.records[0].newSlot == 'D002'
And match $.response.payload.records[0].oldSlot == 'D001'
