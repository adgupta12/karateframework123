@All @WS040 @WS040_TC002 @Store @DwellTime
Feature: WS040_TC002_Store_DwellTime_POST_AlreadyExtended

Background:
* print 'ws_url -> ', ws_url
* print 'currentDateTimeStamp -> ', currentDateTimeStamp

Scenario Outline: WS040_TC002_<scenarioId>_Store_DwellTime_POST_AlreadyExtended
...
And match $.response.payload.records[0].parcelNumber == parcelNumber1
...
And match $.response.payload.records[0].maxDwellTime == '#null'
