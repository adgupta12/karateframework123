@All @WS017 @WS017_TC007 @Store @B2CClientList
Feature: WS017_TC007_Store_B2CClientList_ASD_isRetrieveAllRef_N_Success_GET

Background:
* print 'ws_url -> ', ws_url
* print 'currentDateTimeStamp -> ', currentDateTimeStamp

Scenario Outline: WS017_TC007_<scenarioId>_Store_B2CClientList_ASD_isRetrieveAllRef_N_Success_GET
