@All @WS017 @WS017_TC008 @Store @B2CClientList
Feature: WS017_TC008_Store_B2CClientList_BLK_isRetrieveAllRef_N_Success_GET

Background:
* print 'ws_url -> ', ws_url
* print 'currentDateTimeStamp -> ', currentDateTimeStamp

Scenario Outline: WS017_TC008_<scenarioId>_Store_B2CClientList_BLK_isRetrieveAllRef_N_Success_GET
