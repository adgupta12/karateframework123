@All @WS016 @WS016_TC002 @Store @TaskManagement
Feature: WS016_TC002_Store_TaskManagement_Success_RetrieveParcel_ZEBRAKSK

Background:
* print 'ws_url -> ', ws_url
* print 'currentDateTimeStamp -> ', currentDateTimeStamp

Scenario Outline: WS016_TC002_<scenarioId>_Store_TaskManagement_Success_RetrieveParcel_ZEBRAKSK
