@All @WS016 @WS016_TC004 @Store @TaskManagement
Feature: WS016_TC004_Store_TaskManagement_Success_RequiredAssistance_ZEBRAKSK

Background:
* print 'ws_url -> ', ws_url
* print 'currentDateTimeStamp -> ', currentDateTimeStamp

Scenario Outline: WS016_TC004_<scenarioId>_Store_TaskManagement_Success_RequiredAssistance_ZEBRAKSK
