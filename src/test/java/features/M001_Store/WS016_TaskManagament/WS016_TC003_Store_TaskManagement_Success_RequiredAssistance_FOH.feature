@All @WS016 @WS016_TC003 @Store @TaskManagement
Feature: WS016_TC003_Store_TaskManagement_Success_RequiredAssistance_FOH

Background:
* print 'ws_url -> ', ws_url
* print 'currentDateTimeStamp -> ', currentDateTimeStamp

Scenario Outline: WS016_TC003_<scenarioId>_Store_TaskManagement_Success_RequiredAssistance_FOH
