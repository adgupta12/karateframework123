@All @WS016 @WS016_TC007 @Store @TaskManagement
Feature: WS016_TC007_Store_TaskManagement_Success_RequiredAssistance_FOH_ForwardSlashOrderNum

Background:
* print 'ws_url -> ', ws_url
* print 'currentDateTimeStamp -> ', currentDateTimeStamp

Scenario Outline: WS016_TC007_<scenarioId>_Store_TaskManagement_Success_RequiredAssistance_FOH_ForwardSlashOrderNum
...
And match $.response.payload.records[0].alertDesc == 'requiredAssistance from FOH'
