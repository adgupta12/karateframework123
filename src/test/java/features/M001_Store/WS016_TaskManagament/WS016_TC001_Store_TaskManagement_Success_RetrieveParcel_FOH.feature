@All @WS016 @WS016_TC001 @Store @TaskManagement
Feature: WS016_TC001_Store_TaskManagement_Success_RetrieveParcel_FOH

Background:
* print 'ws_url -> ', ws_url
* print 'currentDateTimeStamp -> ', currentDateTimeStamp

Scenario Outline: WS016_TC001_<scenarioId>_Store_TaskManagement_Success_RetrieveParcel_FOH
