@All @WS016 @WS016_TC006 @Store @TaskManagement
Feature: WS016_TC006_Store_TaskManagement_Success_RetrieveParcel_ZEBRAKSK_ForwardSlashOrderNum

Background:
* print 'ws_url -> ', ws_url
* print 'currentDateTimeStamp -> ', currentDateTimeStamp

Scenario Outline: WS016_TC006_<scenarioId>_Store_TaskManagement_Success_RetrieveParcel_ZEBRAKSK_ForwardSlashOrderNum     
...
And match $.response.payload.records[0].alertDesc == 'retrieveParcel from ZEBRAKSK'
