@All @WS016 @WS016_TC010 @Store @TaskManagement
Feature: WS016_TC010_Store_TaskManagement_Success_RetrieveParcel2_FOH_ForwardSlashOrderNum

Background:
* print 'ws_url -> ', ws_url
* print 'currentDateTimeStamp -> ', currentDateTimeStamp

Scenario Outline: WS016_TC010_<scenarioId>_Store_TaskManagement_Success_RetrieveParcel2_FOH_ForwardSlashOrderNum
