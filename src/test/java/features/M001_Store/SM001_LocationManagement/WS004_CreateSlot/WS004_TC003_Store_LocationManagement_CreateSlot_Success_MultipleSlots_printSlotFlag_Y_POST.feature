@All @WS004 @WS004_TC003 @Store @LocationManagement @CreateSlot
Feature: WS004_TC003_Store_LocationManagement_CreateSlot_Success_MultipleSlots_printSlotFlag_Y_POST

Background:
* print 'ws_url -> ', ws_url
* print 'currentDateTimeStamp -> ', currentDateTimeStamp

Scenario Outline: WS004_TC003_<scenarioId>_Store_LocationManagement_CreateSlot_Success_MultipleSlots_printSlotFlag_Y_POST
...
And match $.invocationResult.result.successSlotList[0].labelNumber == <zoneId> + <slotId1>
* def labelImageCode1 = $.invocationResult.result.successSlotList[0].labelImageCode
And match labelImageCode1 == '#regex [A-Za-z0-9+=\\/]+'
* def decodedLabelImageCode1 = decodeBase64Barcode(labelImageCode1)
And match decodedLabelImageCode1 == <zoneId> + <slotId1>

And match $.invocationResult.result.successSlotList[1].labelNumber == <zoneId> + <slotId2>
And match $.invocationResult.result.successSlotList[1].labelImageCode == '#null'
And match $.invocationResult.result.successSlotList[2].labelNumber == <zoneId> + <slotId3>
And match $.invocationResult.result.successSlotList[2].labelImageCode == '#null'
