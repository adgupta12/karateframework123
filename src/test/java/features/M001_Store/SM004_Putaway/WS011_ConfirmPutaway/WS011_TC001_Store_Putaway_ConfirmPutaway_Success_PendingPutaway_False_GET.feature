@All @WS011 @WS011_TC001 @Store @ConfirmPutaway
Feature: WS011_TC001_Store_Putaway_ConfirmPutaway_Success_PendingPutaway_False_GET

Background:
* print 'ws_url -> ', ws_url
* print 'currentDateTimeStamp -> ', currentDateTimeStamp

Scenario Outline: WS011_TC001_<scenarioId>_Store_Putaway_ConfirmPutaway_Success_PendingPutaway_False_GET
...
And match $.invocationResult.result.pendingPutaway == 'false'
