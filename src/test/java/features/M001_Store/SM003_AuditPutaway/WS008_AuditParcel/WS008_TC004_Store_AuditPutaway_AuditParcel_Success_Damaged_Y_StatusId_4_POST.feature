@All @WS008 @WS008_TC004 @Store @AuditPutaway @AuditParcel @ignore
Feature: WS008_TC004_Store_AuditPutaway_AuditParcel_Success_Damaged_Y_StatusId_4_POST

Background:
* print 'ws_url -> ', ws_url
* print 'currentDateTimeStamp -> ', currentDateTimeStamp

Scenario Outline: WS008_TC004_<scenarioId>_Store_AuditPutaway_AuditParcel_Success_Damaged_Y_StatusId_4_POST
...
And match $.invocationResult.errors.errorDesc == 'Damaged Parcel In Expected Location'
