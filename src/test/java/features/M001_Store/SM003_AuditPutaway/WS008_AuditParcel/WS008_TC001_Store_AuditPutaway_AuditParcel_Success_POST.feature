@All @WS008 @WS008_TC001 @Store @AuditPutaway @AuditParcel
Feature: WS008_TC001_Store_AuditPutaway_AuditParcel_Success_POST
...
Scenario Outline: WS008_TC001_<scenarioId>_Store_AuditPutaway_AuditParcel_Success_POST
...
| S001       | 'vn0hwvq' | '05755' | 'STORE' | '1122334455' | '001'  |
| S002       | 'vn0hwvq' | '05731' | 'STORE' | '1122334455' | '002'  |
