@All @WS018 @WS018_TC002 @Store @CompleteCollection @ignore
Feature: WS018_TC002_Store_CompleteCollection_Success_POST_ForwardSlashOrderNum

Background:
* print 'ws_url -> ', ws_url
* print 'currentDateTimeStamp -> ', currentDateTimeStamp

Scenario Outline: WS018_TC002_<scenarioId>_Store_CompleteCollection_Success_POST_ForwardSlashOrderNum

#* def parcelNumber = getB2CParcelNumberTNAS(<storeId>,'4','1','TNAS')
#* def parcelNumber = getB2CParcelNumber(<storeId>,'4','1','vn0hwvq')
* def parcelNumber = 'MISC053160976'
