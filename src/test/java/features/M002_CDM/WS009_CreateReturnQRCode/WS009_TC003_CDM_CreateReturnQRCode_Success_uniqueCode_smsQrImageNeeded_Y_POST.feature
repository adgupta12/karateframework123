@All @WS009 @WS009_TC003 @CDM @CreateReturnQRCode @ignore
Feature: WS009_TC003_CDM_CreateReturnQRCode_Success_uniqueCode_smsQrImageNeeded_Y_POST

Background:
* print 'ws_cdm_url -> ', ws_cdm_url
* print 'currentDateTimeStamp -> ', currentDateTimeStamp

Scenario Outline: WS009_TC003_<scenarioId>_CreateReturnQRCode_Success_uniqueCode_smsQrImageNeeded_Y_POST
