@All @WS048 @WS048_TC002 @CDM @RASwEDD
Feature: WS048_TC002_CDM_RASwEDD_Success_GET

Background:
* print 'ws_cdm_url -> ', ws_cdm_url
* print 'currentDateTimeStamp -> ', currentDateTimeStamp
 
Scenario Outline: WS048_TC002_<scenarioId>_CDM_RASwEDD_Success_GET
 
#prefFacilityId - isCapacityChkRqrd = false
