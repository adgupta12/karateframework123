@All @WS042 @WS042_TC002 @CDM @ConfigItems
Feature: WS042_TC002_CDM_ConfigItems_ZEBRAKSK_Success_GET

Background:
* print 'ws_cdm_url -> ', ws_cdm_url
* print 'currentDateTimeStamp -> ', currentDateTimeStamp
 
Scenario Outline: WS042_TC002_<scenarioId>_CDM_ConfigItems_ZEBRAKSK_Success_GET
