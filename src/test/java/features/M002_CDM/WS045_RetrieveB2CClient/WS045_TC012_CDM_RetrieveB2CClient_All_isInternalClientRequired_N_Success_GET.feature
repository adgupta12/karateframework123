@All @WS045 @WS045_TC012 @CDM @RetrieveB2CClient
Feature: WS045_TC012_CDM_RetrieveB2CClient_All_isInternalClientRequired_N_Success_GET

Background:
* print 'ws_cdm_url -> ', ws_cdm_url
* print 'currentDateTimeStamp -> ', currentDateTimeStamp

Scenario Outline: WS045_TC012_<scenarioId>_CDM_RetrieveB2CClient_All_isInternalClientRequired_N_Success_GET
