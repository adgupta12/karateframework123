@All @WS045 @WS045_TC004 @CDM @RetrieveB2CClient
Feature: WS045_TC004_CDM_RetrieveB2CClient_clientId_isImageReq_N_GEC_Success_GET

Background:
* print 'ws_cdm_url -> ', ws_cdm_url
* print 'currentDateTimeStamp -> ', currentDateTimeStamp

Scenario Outline: WS045_TC004_<scenarioId>_CDM_RetrieveB2CClient_clientId_isImageReq_N_GEC_Success_GET
