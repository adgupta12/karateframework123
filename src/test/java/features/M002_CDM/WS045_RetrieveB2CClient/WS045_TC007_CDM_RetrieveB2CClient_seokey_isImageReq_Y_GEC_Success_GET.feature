@All @WS045 @WS045_TC007 @CDM @RetrieveB2CClient
Feature: WS045_TC007_CDM_RetrieveB2CClient_seokey_isImageReq_Y_GEC_Success_GET

Background:
* print 'ws_cdm_url -> ', ws_cdm_url
* print 'currentDateTimeStamp -> ', currentDateTimeStamp

Scenario Outline: WS045_TC007_<scenarioId>_CDM_RetrieveB2CClient_seokey_isImageReq_Y_GEC_Success_GET
