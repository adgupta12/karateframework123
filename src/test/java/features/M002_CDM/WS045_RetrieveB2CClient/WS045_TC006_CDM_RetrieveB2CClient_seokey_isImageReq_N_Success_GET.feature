@All @WS045 @WS045_TC006 @CDM @RetrieveB2CClient
Feature: WS045_TC006_CDM_RetrieveB2CClient_seokey_isImageReq_N_Success_GET

Background:
* print 'ws_cdm_url -> ', ws_cdm_url
* print 'currentDateTimeStamp -> ', currentDateTimeStamp

Scenario Outline: WS045_TC006_<scenarioId>_CDM_RetrieveB2CClient_seokey_isImageReq_N_Success_GET
