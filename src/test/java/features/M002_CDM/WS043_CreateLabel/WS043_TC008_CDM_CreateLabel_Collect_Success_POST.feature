@All @WS043 @WS043_TC008 @CDM @CreateLabel
Feature: WS043_TC008_CDM_CreateLabel_Collect_Success_POST

Background:
* print 'ws_cdm_url -> ', ws_cdm_url
* print 'currentDateTimeStamp -> ', currentDateTimeStamp
 
Scenario Outline: WS043_TC008_<scenarioId>_CDM_CreateLabel_Collect_Success_POST
