@All @WS043 @WS043_TC001 @CDM @CreateLabel
Feature: WS043_TC001_CDM_CreateLabel_Return_Success_POST

Background:
* print 'ws_cdm_url -> ', ws_cdm_url
* print 'currentDateTimeStamp -> ', currentDateTimeStamp
 
Scenario Outline: WS043_TC001_<scenarioId>_CDM_CreateLabel_Return_Success_POST
