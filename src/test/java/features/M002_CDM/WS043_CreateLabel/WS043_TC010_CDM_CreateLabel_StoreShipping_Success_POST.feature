@All @WS043 @WS043_TC010 @CDM @CreateLabel
Feature: WS043_TC010_CDM_CreateLabel_StoreShipping_Success_POST

Background:
* print 'ws_cdm_url -> ', ws_cdm_url
* print 'currentDateTimeStamp -> ', currentDateTimeStamp
 
Scenario Outline: WS043_TC010_<scenarioId>_CDM_CreateLabel_StoreShipping_Success_POST
