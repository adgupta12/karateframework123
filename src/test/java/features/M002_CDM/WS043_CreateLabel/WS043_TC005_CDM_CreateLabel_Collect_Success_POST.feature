@All @WS043 @WS043_TC005 @CDM @CreateLabel
Feature: WS043_TC005_CDM_CreateLabel_Collect_Success_POST

Background:
* print 'ws_cdm_url -> ', ws_cdm_url
* print 'currentDateTimeStamp -> ', currentDateTimeStamp
 
Scenario Outline: WS043_TC005_<scenarioId>_CDM_CreateLabel_Collect_Success_POST
